...
%***************************************************************************
%Fecha de última motificación: 25-Febrero-2025
...
\backgroundsetup{ scale=1, angle=0, opacity=.1, color=pink,contents={\includegraphics[width=.7\paperwidth]{figuras/logoEPS-UAH.jpg}}, vshift=-50pt,hshift=0pt}
...
%Para el TFG descomenta la siguiente línea
\include{portada-tfg}
%Para el TFM descomenta la siguiente línea
%\include{portada-tfm}
...
%Para el TFG descomenta la siguiente línea
\include{contraportada-tfg}
%Para el TFM descomenta la siguiente línea
%\include{contraportada-tfm}
